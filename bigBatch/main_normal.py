...
parser.add_argument('--results_dir', metavar='RESULTS_DIR',
                    default='/home/shai/tensorflow/generated_data/Pytorch/', help='results dir')
...
parser.add_argument('--sqrt_factor', dest='sqrt_factor', action='store_true',
                    help='')
parser.set_defaults(sqrt_factor=False)
####### SV LR UPDATE scheme #########
parser.add_argument('--disable_lr_change', dest='disable_lr_change', action='store_true',
                    help='')
parser.add_argument('--enable_lr_change', dest='disable_lr_change', action='store_false',
                    help='')
parser.set_defaults(disable_lr_change=False)

parser.add_argument('--iters_per_adjust', type=int, default=None,
                    help='')
################
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        if args.disable_lr_change == True:
            tmp_base_optimizer = adjust_optimizer(optimizer.base_optimizer, epoch, regime)
